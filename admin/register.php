          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="" method="POST">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="exampleFirstName" name="fname" placeholder="Full Name">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="exampleLastName" name="uname" placeholder="User Name">
                  </div>
                </div>
             ...
             $repass=mysqli_real_escape_string($connect,$_POST['repassword']);
              ...
              if($pass==$repass){
                $hasspass=sha1($pass);
                $registerquery="INSERT INTO users (name,user_name,password,email,phone,adress,avatar, role, is_active,join_date) VALUES('$fname','$username','$pass','$email','$phone','','',1,0,now() )";
                $registeruser=mysqli_query($connect,$registerquery);
                if(!$registeruser){
